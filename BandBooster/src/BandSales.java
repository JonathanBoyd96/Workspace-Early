...
//
// Jonathan Boyd
// Lab 4: A Band Booster
// 
// BandSales.java
// Compiles a class that models a band booster and uses the 
...
public class BandSales 
{
	public static void main (String [] args)
	{
		...
		// Scans for the number of boxes sold during a certain week, and then updates the sales
			System.out.println ("Enter the boxes sold by Joe in the first week: "); 
			jweek1 = scan.nextInt();
			joe.updateSales(jweek1);
			
			System.out.println ("Enter the boxes sold by Mary in the first week: "); 
			mweek1 = scan.nextInt();
			mary.updateSales(mweek1);
			
			System.out.println ("Enter the boxes sold by Joe in the second week: "); 
			jweek2 = scan.nextInt();
			joe.updateSales(jweek2);
			
			System.out.println ("Enter the boxes sold by Mary in the second week: "); 
			mweek2 = scan.nextInt();
			mary.updateSales(mweek2);
			
			System.out.println ("Enter the boxes sold by Joe in the third week: "); 
			jweek3 = scan.nextInt();
			joe.updateSales(jweek3);
			
			System.out.println ("Enter the boxes sold by Mary in the third week: "); 
			mweek3 = scan.nextInt();
